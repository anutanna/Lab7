...
1. Lab 6 – 3172 Course. (n.d.). Weather API integration exercise. Retrieved March 14, 2025, from https://eclectic-banoffee-033ff4.netlify.app/#hero
2. OpenWeather. (n.d.). Weather API documentation. Retrieved March 14, 2025, from https://openweathermap.org/api
3. React Documentation. (n.d.). Retrieved March 14, 2025, from https://react.dev/
4. Tailwind CSS Documentation. (n.d.). Retrieved March 14, 2025, from https://tailwindcss.com/docs
